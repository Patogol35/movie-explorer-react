...
export default function SearchFilter({ genres = [], onChange }) {
  ...
  return (
    <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 220px auto', gap: 1 }}>
      <TextField
      ...
      <FormControl>
        ...
        <Select value={genre} label="Género" onChange={e => setGenre(e.target.value)} sx={{ minWidth: 160 }}>
      ...
      <IconButton onClick={clear} aria-label="limpiar">
        <CloseIcon />
      </IconButton>
    </Box>
  )
